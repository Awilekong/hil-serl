...
class RobotInterface(BaseRobotInterface):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # 添加一个属性来记录最近期望的关节位置
        self.last_desired_joint_positions = None
    ...
    def get_desired_joint_positions(self) -> torch.Tensor:
        """Returns the last desired joint positions that were set.
        Returns None if no desired positions have been set yet.
        """
        return self.last_desired_joint_positions
    ...
    def update_desired_joint_positions(self, positions: torch.Tensor) -> int:
        ...
        try:
            ...
            # 记录这次设置的期望关节位置
            self.last_desired_joint_positions = positions.clone()
        except grpc.RpcError as e:
            log.error(
